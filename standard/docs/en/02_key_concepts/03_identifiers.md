...
## Tender, award and contract identifiers
...
Users wishing to store a globally unique identifier for an award or contract can do so by concatenating together the OCID and related award or contract ID. 
